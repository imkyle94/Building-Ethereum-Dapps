		...
		it("Cannot transfer a number of tokens higher than number of tokens owned", function() {
			...
			return SimpleCoin.deployed().then(function(instance) {
			  ...
			  return simpleCoin.transfer(recipient, tokensToTransfer, {from: sender});
					  ...
					  assert(false, "transfer of insufficient tokens should have failed");
					  return true;
				  },
				  function(e) {				  
					  assert.match(e, /VM Exception while processing transaction/, "transfer of insufficient tokens should have raised VM exception");			  
				  });						
		});			
